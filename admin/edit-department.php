...
$database = $database->getConnection();
    if (strlen($_SESSION['alogin'])==0) {
        ...
        if (isset($_POST['update'])) {
            ...
            $depthead = $_POST['departmenthead'];
            $deptcode=$_POST['deptcode'];
            $sql="UPDATE departments SET DepartmentName = :deptname, DepartmentCode = :deptcode, DepartmentShortName = :deptshortname, DepartmentHead = :depthead WHERE id = :deptid";
    ...
    <div class="page-container">
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        ...
                        <?php if ($error) {?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                             ...
                             </div><?php } elseif ($msg) {?><div class="alert alert-success alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($msg); ?> 
                                 <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                                 </div><?php } ?>
        ...
        if ($query->rowCount() > 0) {
            foreach ($results as $result) {               ?> 
                                        ...
                                        <div class="form-group">
                                            <label for="departmentshortname" class="col-form-label">Department Initial</label>
                                        ...
                                        <div class="form-group">
                                            <label for="deptcode" class="col-form-label">Department Code</label>
                                        ...
                                        <div class="form-group">
                                            <label for="departmenthead" class="col-form-label">Department Head</label>
                                            <input class="form-control" name="departmenthead" type="email" autocomplete="off" required id="departmenthead" value="<?php echo htmlentities($result->DepartmentHead);?>">
                                        </div>
                                        ...
                                        <a href="department.php" class="btn btn-secondary"> BACK </a>
