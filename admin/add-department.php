...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['add'])) {
        ...
        $sql = "INSERT INTO departments(DepartmentName, DepartmentCode, DepartmentShortName, DepartmentHead) VALUES(:deptname, :deptcode, :deptshortname, :depthead)";
                                ...
                                <form method="POST">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="departmenthead" type="email" autocomplete="off" required id="departmenthead">
                                        </div>

                                        <button class="btn btn-primary" name="add" id="add" type="submit">ADD</button>
                                        <a class="btn btn-secondary" href="department.php">BACK</a>
