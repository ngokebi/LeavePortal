...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "UPDATE leaves set AdminRemark=:description,Status=:status,AdminRemarkDate=:admremarkdate where id=:leaveid";
        $query = $database->prepare($sql);
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover text-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    $leaveid = intval($_GET['leaveid']);
                                                    $sql = "SELECT  leaves.id as leaveid, employees.FirstName, employees.LastName, employees.EmployeeId, employees.id, employees.Gender, employees.Phonenumber, employees.Email, leaves.LeaveType, leaves.EndDate, leaves.StartDate, leaves.Description, leaves.DateCreated, leaves.Status, leaves.AdminRemark, leaves.AdminRemarkDate, leaves.DeptHeadRemark, leaves.DeptHeadRemarkDate from  leaves join  employees on  leaves.EmpID= employees.id where  leaves.id=:leaveid";
                                                    $query = $database->prepare($sql);
                                                    $query->bindParam(':leaveid', $leaveid, PDO::PARAM_STR);
                                                    $query->execute();
                                                    ...
                                                    ?>
                                                            ...
                                                            <tr>
                                                                <td><b>DeptHead Date of Remark: </b></td>
                                                                <td><?php
