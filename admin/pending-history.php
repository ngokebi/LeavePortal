                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover table-striped table-bordered progress-table text-center">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $status = 1;
                                                    $sql = "SELECT leaves.id as lid, employees.FirstName, employees.LastName, employees.EmployeeId, employees.id, leaves.LeaveType, leaves.DateCreated, leaves.Status from  leaves join  employees on  leaves.EmpID= employees.id where  leaves.Status=:status order by lid desc";
