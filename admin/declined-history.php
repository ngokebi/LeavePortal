                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover table-striped table-bordered progress-table text-center">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $status = 3;
                                                    $sql = "SELECT leaves.id as leaveid, employees.FirstName, employees.LastName, employees.EmployeeId, employees.id, leaves.LeaveType, leaves.DateCreated, leaves.Status FROM  leaves JOIN  employees ON  leaves.empid= employees.id WHERE  leaves.Status = :status ORDER BY leaveid DESC";
