...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "UPDATE leavetype SET LeaveType = :leavetype, Description = :description WHERE id = :leaveid";
        ...
        $_SESSION["SuccessMessage"] = "Leave type updated successfully";
        Redirect_to('leave-section.php');
    }
                            ...
                            <div class="card">
                                ...
                                <form method="POST">
                                    <div class="card-body">
                                        ...
                                        <?php
                                        $leaveid = intval($_GET['leaveid']);
                                        $sql = "SELECT * from leavetype where id = :leaveid";
                                        $query = $database->prepare($sql);
                                        $query->bindParam(':leaveid', $leaveid, PDO::PARAM_STR);
                                        $query->execute();
                                        ...
                                        <a href="leave-section.php" class="btn btn-secondary" style="margin-left: 4px;">BACK</a>
