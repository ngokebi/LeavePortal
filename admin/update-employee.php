...
$database = $database->getConnection();
    ...
    $sql="UPDATE employees set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,DeptHead=:depthead,Department=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno where id=:eid";
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="empcode" type="text" autocomplete="off" readonly required value="<?php echo htmlentities($result->EmployeeId);?>" id="example-text-input">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" name="depthead" autocomplete="off">
                                            <option value="<?php echo htmlentities($result->DeptHead);?>"><?php echo htmlentities($result->DeptHead);?></option>

                                            <?php $sql = "SELECT DepartmentHead from departments";
                                                $query = $database->prepare($sql);
                                                $query->execute();
                                                $results=$query->fetchAll(PDO::FETCH_OBJ);
                                                $cnt=1;
                                                ...
                                                {   
                                            ?>  
                                                <option value="<?php echo htmlentities($resultt->DepartmentHead);?>"><?php echo htmlentities($resultt->DepartmentHead);?></option>
                                        <?php }} ?>
                                        </select>
                                        </div>           
