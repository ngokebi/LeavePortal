...
if (isset($_POST['signin'])) {
    ...
    $sql = "SELECT * FROM employees WHERE Email=:uname and Password=:password";
    ...
    if ($query->rowCount() > 0) {
        ...
        if ($status == "Inactive") {
            ...
            $_SESSION["ErrorMessage"] = "In-Active Account. Please contact your administrator!";
        } else {
            $_SESSION['emplogin'] = $_POST['username'];
            // echo "<script type='text/javascript'> document.location = 'employees/employee-dashboard.php'; </script>";
            Redirect_to('employees/dashboard.php');
        }
    } else {
