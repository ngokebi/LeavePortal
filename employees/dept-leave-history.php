                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <div class="breadcrumbs-area clearfix">
                                <h4 class="page-title pull-left">Department Leave History</h4>
                            </div>
                        </div>
                                    ...
                                    <div class="data-tables">
                                        <table id="dataTable" class="table table-hover progress-table text-center">
                                            ...
                                            <tbody>
                                                ...
                                                $sql = "SELECT leaves.id as lid, employees.FirstName, employees.LastName, leaves.Status, leaves.LeaveType, leaves.StartDate, leaves.EndDate, leaves.AdminRemark, leaves.DeptHeadRemark from  leaves join  employees on  leaves.EmpID= employees.id where employees.DeptHead=:eid order by lid desc";
