                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover table-striped table-bordered progress-table text-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    $status = 1;
                                                    $depthead = $username;
                                                    $sql = "SELECT leaves.id as leaveid, employees.FirstName, employees.LastName, employees.EmployeeId, employees.DeptHead, employees.id, leaves.LeaveType, leaves.DateCreated, leaves.Status from  leaves join  employees on  leaves.EmpID= employees.id where  leaves.Status=:status AND employees.DeptHead =:depthead order by leaveid desc";
