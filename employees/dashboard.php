                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover table-bordered table-striped progress-table text-center" id="dataTable3">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $eid = $_SESSION['eid'];
                                                    $sql = "SELECT leaves.id as leaveid, employees.FirstName, employees.LastName, employees.EmployeeId, employees.id, leaves.LeaveType, leaves.DateCreated, leaves.Status FROM leaves JOIN employees ON leaves.EmpID = employees.id WHERE employees.id=:eid ORDER BY leaveid DESC ";
